...
* Introduction
Hi! Welcome to my literate programming Emacs configuration (vi vi vi users are not invited). There are two reasons that I've created this:
1. I always forget how I've configured emacs. 
2. This might be useful for some people.
...
#+end_src
** Use Package
I use =use-pacakge= to install and configure packages.
#+begin_src emacs-lisp
...
* UI
** Basic Settings
This section removes all the extra parts from emacs to make it look more minimal.
#+begin_src emacs-lisp
  ; Disable the text that appears when first open the emacs
...
#+end_src
** Theme
I use doom theme package to set theme for emacs. It contains a list of diverse and beautiful themes.
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
	...
	(setq org-agenda-files
			'("~/Documents/GTD/tasks.org"
			  "~/Documents/GTD/inbox.org"
			  "~/Documents/GTD/projects.org"
			  "~/Documents/GTD/repeated.org"
	  ...
	  (setq org-capture-templates
	      `(("i" "inbox")
	       ("ii" "Task" entry (file+olp "~/Documents/GTD/inbox.org" "Inbox")
		"* TODO %?\n  %U\n" :empty-lines 1)))
...
#+begin_src emacs-lisp
  (use-package ox-hugo
    ...
    :pin melpa  
    :after ox)
  (setq org-hugo-base-dir "~/Documents/amirmtaati")
#+end_src
** Deft
#+begin_src emacs-lisp
    (use-package deft
